...
// Compiled at: 2026-09-20T14:24:08.101Z
...
(function() {
  ...
  function formatTimerUnit(unit) {
    ...
    if (u === 'ms' || u.startsWith('millisec')) return '\u6beb\u79d2';
    if (u === 'm' || u.startsWith('min')) return '\u5206\u949f';
    if (u === 'h' || u.startsWith('hour') || u === 'hr' || u === 'hrs') return '\u5c0f\u65f6';
